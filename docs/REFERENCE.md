...
/journal started  "Beginning PROJ-142 — extract auth-service subchart."
/journal done     "PROJ-142 PR #57 merged and validated in staging."
/journal blocker  "Registry push failing — CI role missing pull/push permission."
/journal pr       "PR #61 opened for billing-service extraction."
```
